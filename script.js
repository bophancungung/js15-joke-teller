...
function tellMe(joke) {
  VoiceRSS.speech({
    key: '07ecc158e1bd44a2be1981f7e0999040',
    src: joke,
    hl: 'en-us',
    r: 0,
    c: 'mp3',
...
async function getJokes() {
  const apiUrl = 'https://v2.jokeapi.dev/joke/Miscellaneous?blacklistFlags=nsfw,religious,political,racist,sexist,explicit&type=single'
  try {
    ...
    // Catch error here
    console.log('getJokes fn error:', error);
  }
}
